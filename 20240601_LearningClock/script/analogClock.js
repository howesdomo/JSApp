...
function AnalogClock(id, option, datetime) {
	...
	//start the clock (the animation part)
		...
		var roS = 1.0 * 360 / 60 * datetime.getSeconds();
		var roM = 1.0 * 360 / 60 * datetime.getMinutes();
		var roH = 1.0 * 360 / 12 * (datetime.getHours() % 12) + 1.0 * 360 / 12 * (datetime.getMinutes() / 60);
